...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        wget -N --no-check-certificate -O /usr/local/x-ui-linux-$(archxui).tar.gz https://github.com/4xmen/radepa-x-ui/releases/download/${last_version}/x-ui-linux-$(archxui).tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/4xmen/radepa-x-ui/releases/download/${last_version}/x-ui-linux-$(archxui).tar.gz"
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/4xmen/radepa-x-ui/main/x-ui.sh
