...
func (a *InboundController) getClientTraffic(email string, password string, c *gin.Context) {
	clientTraffics, err := a.inboundService.GetClientTrafficByEmailPassword(email, password)
	if err != nil {
		jsonMsg(c, "Error getting traffics", err)
		return
	}
